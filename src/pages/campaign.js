            ...
            <div className="cover-table">
              <div class="table-container-berita">
                <table class="table custom-table">
                  <thead>
                    <tr className="title">
                      <th scope="col" style={{ padding: "1rem" }}>Nama</th>
                      <th scope="col" style={{ padding: "1rem" }}>Status</th>
                      <th scope="col" style={{ padding: "1rem" }}>Inisiator</th>
                      <th scope="col" style={{ padding: "1rem", textAlign: "end" }}>Dana yang diajukan</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td className="text-1 fw-slug text-end py-3">Rp100.000.000</td>
                    </tr>
                    <tr>
                      <th scope="row" className=" d-flex p-3 align-items-center">
