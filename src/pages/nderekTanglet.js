...
import Defaulthideshow from "./coba";
            ...
            <table class="table custom-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ color: "#252C32", height: "auto" }}>
                    Sep 26, 2023
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  >
                    <p style={{ fontSize: "14px", color: "#252C32" }}>
                      Ziyad Ahmad Baharuddin
                    </p>
                    <p
                      style={{
                ...
                {/* page */}
                <tr>
                  <th colspan="4" className="text-1 fw-normal ps-3 pt-3">Page 1 of 1</th>
