            ...
            <table class="table custom-table" style={{ width: "100%" }}>
              ...
              <tbody>
                ...
                <tr style={{ fontSize: "14px", color: "#404040" }}>
                  ...
                  <td style={{ padding: "1rem", color: "#404040" }}>
                    01 Okt 2023 08:43:04 WIB
                  </td>
                  <td
                    style={{
                      padding: "1rem",
                  ...
                  <td
                    className="text-1 fw-bold"
                    style={{ padding: "1rem", color: "#404040" }}
                  >
                    Rp750.000
                  </td>
                ...
                >
                  <th
                    colspan="3"
                    className="text-1 fw-normal ps-3 pt-3"
                    style={{ width: "100%" }}
                  >
                    Page 1 of 1
                  </th>
