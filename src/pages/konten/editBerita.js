        ...
        <div className="px-3 px-md-4 py-4">
          <div className="mb-4">
            <div className="d-flex justify-content-between">
              ...
              <div className="d-flex">
                ...
                <Button
                  variant="outline-success add-publish-btn ms-2 fw-semibold text-white"
          ...
          <div className="bg-white rounded-4 p-4">
            ...
            <div class="input-group mb-3">
              <input
                type="text"
                placeholder="Silaturahim dengan PCNU Kota Batu, KaKanKemenag : Perkuat Sinergi !"
            ...
            <div className="mb-4 ">
                <div className="uploads">
                    <div className="uploaded-image">
                      <img
                        src="../assets/berita/editberita.svg"
